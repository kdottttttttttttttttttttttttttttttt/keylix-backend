...
// Fix CheckPlatformPlayAllowed - 12.41 expects text/plain "true" per FortServer (C# returns Content("true") with text/plain)
...
router.get('/fortnite/api/game/v2/tryPlayOnPlatform/account/:accountId', (req,res)=>{ res.set('Content-Type','text/plain'); res.send('true'); });
router.all('/fortnite/api/game/v2/tryPlayOnPlatform/*', (req,res)=>{ res.set('Content-Type','text/plain'); res.send('true'); });
