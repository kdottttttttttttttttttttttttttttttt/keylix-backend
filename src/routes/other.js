...
// Fix CheckPlatformPlayAllowed - actual Fortnite 12.41 endpoint is POST /fortnite/api/game/v2/tryPlayOnPlatform/account/:id?platform=Windows -> returns boolean true
router.post('/fortnite/api/game/v2/tryPlayOnPlatform/account/:accountId', (req,res)=>res.json(true));
